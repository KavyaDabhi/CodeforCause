...
interface EventNode {
  ...
  venue: string;
  posterUrl?: string;
  // 🚀 regLink has been retired! We use internal dynamic routing now.
}
            ...
            <div className="flex flex-col lg:flex-row flex-1 overflow-hidden">
              <div className="lg:w-[45%] bg-black flex items-center justify-center border-b lg:border-b-0 lg:border-r border-[#2a2e3f] shrink-0 bg-[url('/grid.png')] bg-repeat relative">
                {selectedEvent.posterUrl ? (
                  <img src={selectedEvent.posterUrl} alt={selectedEvent.title} className="w-full h-full object-contain max-h-[35vh] lg:max-h-none p-4 md:p-0" />
                ) : (
