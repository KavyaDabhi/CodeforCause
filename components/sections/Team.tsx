          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-8 w-full justify-items-center">
            {allCoreOperatives.map((student) => (
              ...
              >
                ...
                {/* 🎯 UPDATED: Added College ID here */}
                <div className="flex flex-col sm:items-center">
                  <h3 className="text-base md:text-xl font-bold text-white uppercase tracking-wide mb-1 sm:text-center group-hover:text-[#00d2ff] transition-colors">
                    {student.name}
                  </h3>
                  
                  {student.collegeId && (
                    <span className="text-[#50fa7b] font-mono text-[10px] tracking-[0.2em] mb-3 uppercase">
                      [{student.collegeId}]
                    </span>
                  )}

                  <span className="text-[#00d2ff] font-mono text-xs uppercase bg-[#00d2ff]/10 px-3 py-1 rounded-full border border-[#00d2ff]/20 sm:text-center line-clamp-1">
                    {student.role}
                  </span>
                </div>
              </a>
